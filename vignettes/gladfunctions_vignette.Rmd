...
#### `as.numeric` factor variables to run certain models
...
Applying `as.numeric` to the R built-in class `factor` only obtains its
...
* Don't seem to have a general way to extract the tile from the
