...
# Take the first element of the sheet list - `GLAD_sheet` is a vectorized
# function.
...
* Note that for these variables, it is possible to supply a logical
  ...
  deciding cut-offs. When `include_outlier` is set to `FALSE`, it's also
